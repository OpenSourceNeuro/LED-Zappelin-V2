...
void BlankingNonInversion(){
  BlankingInvert = false;
}

void BlankingInversion(){
  BlankingInvert = true;
}
...
void SCmdAddCommand(){  
  ...
  SCmd.addCommand("B0", BlankingNonInversion);
  SCmd.addCommand("B1", BlankingInversion);
  SCmd.addCommand("BL", BlankingTiming);
}