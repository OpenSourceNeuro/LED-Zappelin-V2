...
bool      OldNeopixel  = true;              // Set Neopixel stick version (RGB vs RGBW)
int       nLED         = 12;                // Total number of LED 
int       Bits         = 10;                // BitDepth for the PWM output


uint8_t        bitDepth     = pow(2,Bits) - 1;      
uint32_t       bitFrequency = 10000;        

/* ----------------------------------------------------------------------------------*/
/* ------------------------------ LED Wavelength (nm) -------------------------------*/

int Wavelength01 = 586;
int Wavelength02 = 487;
int Wavelength03 = 427;
int Wavelength04 = 372;
int Wavelength05 = 750;
int Wavelength06 = 750;
int Wavelength07 = 750;
int Wavelength08 = 750;
int Wavelength09 = 750;
int Wavelength10 = 750;
int Wavelength11 = 750;
int Wavelength12 = 750;
...
int max_LED01 = bitDepth;  
int max_LED02 = bitDepth;  
int max_LED03 = bitDepth;  
int max_LED04 = bitDepth;  
int max_LED05 = bitDepth;  
int max_LED06 = bitDepth;  
int max_LED07 = bitDepth;  
int max_LED08 = bitDepth;  
int max_LED09 = bitDepth;  
int max_LED10 = bitDepth;  
int max_LED11 = bitDepth;  
int max_LED12 = bitDepth;  
...
int max01 = max_LED_Power;  // LED maximum intensity 1
int max02 = max_LED_Power;  // LED maximum intensity 2
int max03 = max_LED_Power;  // LED maximum intensity 3
int max04 = max_LED_Power;  // LED maximum intensity 4
int max05 = max_LED_Power;  // LED maximum intensity 5
int max06 = max_LED_Power;  // LED maximum intensity 6
int max07 = max_LED_Power;  // LED maximum intensity 7
int max08 = max_LED_Power;  // LED maximum intensity 8
int max09 = max_LED_Power;  // LED maximum intensity 9
int max10 = max_LED_Power;  // LED maximum intensity 10
int max11 = max_LED_Power;  // LED maximum intensity 11
int max12 = max_LED_Power;  // LED maximum intensity 12
