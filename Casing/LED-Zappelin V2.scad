...
module PowerSwitch(){
    r_Power = 21/2;
    translate([xoffset_pinPower1+10,y_PCB/2,z_PCB+10])rotate([0,90,0])cylinder(r=r_Power,h=500,$fn=Smoothness);
}
...
module NeoPixelHole(){
    translate([x_PCB/2-x_Neo/2,0,z_PCB+hex_middle-z_Neo]){
        ...
        translate([0,-xxx,zoffset_NeoPixel])cube([x_NeoPixel/2,xxx,z_NeoPixel]);
    }
}
